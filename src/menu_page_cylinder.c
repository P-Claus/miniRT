...
/*   Updated: 2024/09/26 18:31:12 by efret            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_menu_cylinder_page(t_mlx_data *data, t_ui_menu *menu)
{
	...
	add_elem_btn(page, "delete", (t_elem_data){UI_DATA_CYLINDER, obj}, menu_btn_del_cylinder);
	add_elem_space(page);
	...
	add_elem_nbox_bs(page, (t_nbox_norm_bs){"height:", {UI_DATA_FLOAT, &obj->height}, {0., INFINITY, 1.}, menu_nbox_apply_float});
